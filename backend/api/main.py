...
from backend.api.routes import compromisso_router, credenciais_integracoes_router, empresa_router, pergunta_resposta_router, usuario_router, vetor_router,lista_pergunta_resposta_router 
